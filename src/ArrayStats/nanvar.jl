...
function staticdim_nanvar_quote_turbo(static_dims::Vector{Int}, N::Int)
...
function branches_nanvar_quote_turbo(N::Int, M::Int, D)
  static_dims = Int[]
  for m ∈ 1:M
  ...
  staticdim_nanvar_quote_turbo(static_dims, N)
end

# Efficient @generated in-place var
@generated function _nanvar!(B::StridedArray{Tₒ,N}, corrected::Bool, A::StridedArray{T,N}, dims::D) where {Tₒ<:PrimitiveNumber,T,N,M,D<:Tuple{Vararg{IntOrStaticInt,M}}}
  ...
  # else
    branches_nanvar_quote_turbo(N, M, D)
  # end
end
